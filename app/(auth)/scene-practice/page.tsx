...
export default function ScenePractice() {
  const scenes = [
    ...
    {
      description: "煎饼的香气，摊主的手艺，路客的表情，街道的热闹，早晨的温度...",
      image: "/images/street-food.png",
      bgColor: "bg-gradient-to-br from-yellow-100 to-yellow-200",
    },
    {
      description: "欢声笑语，运动的学生，开放的操场，不同学生的活动，天空的颜色...",
      image: "/images/school-playground.png",
      bgColor: "bg-gradient-to-br from-purple-100 to-purple-200",
    },
    {
      description: "南后花园的生气勃勃，水滴的声音，植物的颜色变化，小动物的活动，光线的变化...",
            ...
            >
              <CardContent className="p-0">
                <div className="relative h-64 rounded-t-lg overflow-hidden">
                  <Image src={scene.image || "/placeholder.svg"} alt={scene.description} fill className="object-cover" />
                </div>
                <div className="p-6">
